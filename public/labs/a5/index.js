...
console.log('Implied return') // need to add this extra line?
const multiply = (a, b) => a * b;
const fourTimesFive = multiply(4, 5);
console.log(fourTimesFive);

console.log('Parenthesis and parameters') // need to add this extra line?
const square = a => a * a;
const plusOne = a => a + 1;
...
const squares = numberArray1.map(square); // square function declared earlier
...
const init = () => {
    ...
    // // test
    // console.log($("#set-class-attr").attr('id'))
    // console.log($("#set-class-attr").attr('class'))


    const addClass1Example = $("#add-class-1");
    // console.log(addClass1Example.attr('class'))
    addClass1Example.addClass('class-1');
    // console.log(addClass1Example.attr('class'))

    const removeClass1Example = $("#remove-class-1");
    // console.log(removeClass1Example.attr('class'))
    ...
    //2.17 Appending new elements/add new contents to DOM
    const ul = $("#append-new-elements");
    ul.append(newLineItem);
    ul.append(anotherLineItem);

    // Removing & emptying contents from DOM
    ...
    // 2.20 navigating up & down the DOM tree
    ...
    // 2.22 event target (determine UI element that a user clicked on)
    ...
    // 2.23 handle click events to hide & show DOM elements
