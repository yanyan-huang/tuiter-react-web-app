...
const EditProfile = () => {
    ...
    // const navigate = useNavigate('/tuiter/profile');
        ...
        <div className="text-secondary">
            <div className="d-flex mb-1 pe-3">
                ...
                <button 
                    ...
                    className="col-2 btn btn-dark float-end rounded-pill fw-bold pe-2 m-2">
                        Save
                </button>
            </div>
            ...
            <div>
                <div className="position-relative">
                    <div className="">
                        <img src={`/images/${profile.bannerPicture}`} alt="..." className="opacity-75 w-100"></img>
                    ...
                    <div className="">
                    <img src={`/images/${profile.profilePicture}`} alt="..." className="opacity-75 rounded-circle h-50 card-img-overlay top-50 mt-5 ms-3"></img>
                        <div className="d-flex align-items-start ms-5">
                            <button className="rounded-circle bg-secondary border-0 bg-opacity-75 position-absolute">
